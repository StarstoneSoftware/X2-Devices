...
private:
    ...
    static void __stdcall DataCallback(const void* pData, const MallincamFrameInfoV2* pInfo, int bSnap, void* pCallbackCtx);
    static void __stdcall EventCallback(unsigned nEvent, void* pCallbackCtx);

 
    // ToupTek spcifics
public:
    HMallincam				hCamera;					// Handle to the camera
	MallincamDeviceV2			deviceList[MALLINCAM_MAX];	// List of connected cameras
	MallincamModelV2			cameraInfo;					// Details about the camera
